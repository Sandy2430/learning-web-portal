export const getSearchString = ({ searchBook = "angular" } = {}) => ({
  completeBookSearchList: {
    searchBook,
  },
});
export const createSeachBookListState = ({
  bookList = [
    {
      kind: "books#volume",
      id: "0BSOg0oHhZ0C",
...
export const createSelectedBookState = ({
  selectedBook = {
    title: "Angular Momentum in Quantum Mechanics",
    authors: ["A. R. Edmonds"],
    publisher: "Princeton University Press",
...
export const createGetCartItemState = ({
  cartItem = [
    {
      title: "Angular Momentum in Quantum Mechanics",
      authors: ["A. R. Edmonds"],
...
export const createGetCountState = ({ cartCount = 1 } = {}) => ({
  completeBookSearchList: {
    cartCount,
  },
});
export const createGetProceedToBuyState = ({
  proceedToBuy = {
    title: "Angular Momentum in Quantum Mechanics",
    authors: ["A. R. Edmonds"],
    publisher: "Princeton University Press",
...
export const createGetPurchasedListState = ({
  purchasedItem = [
    {
      title: "Angular Momentum in Quantum Mechanics",
      authors: ["A. R. Edmonds"],
...
export const creategetCollectionCountState = ({
  collectionCount = 1,
} = {}) => ({
  completeBookSearchList: {
    collectionCount,
