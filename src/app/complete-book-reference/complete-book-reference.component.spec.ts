...
describe("complete-book-reference", () => {
  ...
  beforeEach(() => {
    ...
    fixture = new CompleteBookReferenceComponent(mockFacadeService);
    fixture.ngOnInit();
  });
  ...
  describe("Test: getCompleteBookInfo", () => {
    it("Get full book details", () => {
      ...
      const spygetgetCompleteBookInfo = jest
        .spyOn(mockFacadeService, "getCompleteBookInfo")
        .mockReturnValue(response);
      expect(mockFacadeService.getCompleteBookInfo()).toBe(response);
      expect(spygetgetCompleteBookInfo).toHaveBeenCalled();
    });
  });
});
