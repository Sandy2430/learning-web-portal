...
describe("Test: BookListFacadeService", () => {
  ...
  test("Test: getBookList", () => {
    ...
    const getBooksSpy = jest
      .spyOn(store, "select")
      .mockReturnValue(of(booList));
  ...
  test("getCompleteBookInfo", () => {
    ...
    const getCompleteBooSpy = jest
      .spyOn(store, "select")
      .mockReturnValue(of(selectedBookMock));
  ...
  test("getCartItems", () => {
    ...
    const getCompleteBooSpy = jest
      .spyOn(store, "select")
      .mockReturnValue(of(cartItemMock));
  ...
  test("getCartLength", () => {
    const cartLenMock = 1;
    const getCartLenSpy = jest
      .spyOn(store, "select")
      .mockReturnValue(of(cartLenMock));
  ...
  test("getProceedToBuyInfo", () => {
    ...
    const getCompleteBooSpy = jest
      .spyOn(store, "select")
      .mockReturnValue(of(purchasedInfoMock));
  ...
  test("getPurchasedData", () => {
    ...
    const getCompleteBookSpy = jest
      .spyOn(store, "select")
      .mockReturnValue(of(purchasedItemMock));
  ...
  test("getMyCollectionLength", () => {
    ...
    const getMyCollectionLenSpy = jest
      .spyOn(store, "select")
      .mockReturnValue(of(mycollectionLenMock));
  ...
  test("loadSearchString", () => {
    ...
    const searchStringSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(searchStringMock));
  ...
  test("loadBookList", () => {
    ...
    const loadBookListSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(loadBookListMock));
  ...
  test("getSpecificBookInfo", () => {
    ...
    const getCompleteBooSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(specificBookInfoMock));
  ...
  test("addToCart", () => {
    ...
    const addToCartSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(addToCartMock));
  ...
  test("getCartCount", () => {
    ...
    const getCartCountSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(cartCountMock));
  ...
  test("proceedToPurchase", () => {
    ...
    const proceedToPurchaseSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(proceedToPurchaseMock));
  ...
  test("loadPurchaseItem", () => {
    ...
    const loadPurchaseItemSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(loadPurchaseItemMock));
  ...
  test("loadBookPurchasedCount", () => {
    ...
    const loadBookPurchasedCountSpy = jest
      .spyOn(store, "dispatch")
      .mockReturnValue(of(purchasedCountMock));
